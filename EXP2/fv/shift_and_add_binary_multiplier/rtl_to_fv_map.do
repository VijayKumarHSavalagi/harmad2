...
# Generated on: Fri Feb 28 11:13:00 IST 2025 (Fri Feb 28 05:43:00 UTC 2025)
...
set logfile fv/shift_and_add_binary_multiplier/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/shift_and_add_binary_multiplier -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  boot_multiplier.v
elaborate_design -golden -root {shift_and_add_binary_multiplier} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/shift_and_add_binary_multiplier/fv_map.v.gz
elaborate_design -revised -root {shift_and_add_binary_multiplier}
...
#add_name_alias fv/shift_and_add_binary_multiplier/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.shift_and_add_binary_multiplier.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.shift_and_add_binary_multiplier.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.shift_and_add_binary_multiplier.rtl.fv_map.rpt
